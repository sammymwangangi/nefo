...
@section('content')
    @if(count($discussions) > 0)
      ...
      <div class="max-w-sm w-full max-w-full flex shadow-md rounded mb-5 text-xs">
        <div class="rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div class="mb-8">
              <div class="flex-1 flex justify-between mb-4">
                <div>
                  <span class="text-gray-900 ml-1">@include('layouts.channel')</span>
                ...
                <div class="w-56 flex-none text-center">
                  @if($d->hasBestAnswer())
