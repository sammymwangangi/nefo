@if ($d->channel->title == 'Laravel')
	<a href="{{url('channel', ['slug' => $d->channel->slug])}}">
		<button class="bg-transparent hover:bg-green-500 text-gray-800 font-semibold text-xs hover:text-white hover:font-bold py-1 px-2 inline-flex items-center border border-green-400 hover:border-transparent rounded-full">
